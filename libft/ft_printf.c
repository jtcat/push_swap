...
/*   Updated: 2022/12/28 20:32:05 by joaoteix         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "utils.h"

static void	initspecs(t_formspec *specs)
{
	size_t		i;
...
static size_t	ft_subfield(const char **form, va_list args)
{
	t_formspec	specs;
	size_t		field_w;
